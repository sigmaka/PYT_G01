...
def create_matrix(matrix, anzahl_durchlaeufe=2, laenge_snake=4, zeit=0.1, farbe_snake=(5, 5, 5), farbe_spur=(1, 0, 0)):
    """
    ...
    :param farbe_spur: Farbton Schlangenspur, Standard = [1, 0, 0]
    Konzept:
